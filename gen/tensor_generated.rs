...
impl Tensor {
    ...
    pub fn internal_scaled_dot_product_cudnn_attention(
        query: &Tensor, key: &Tensor, value: &Tensor, dropout_p: f64, is_causal: bool, return_debug_mask: bool, scale: impl Into<Option<f64>>
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        Tensor::f_internal_scaled_dot_product_cudnn_attention(query, key, value, dropout_p, is_causal, return_debug_mask, scale).unwrap()
    }
